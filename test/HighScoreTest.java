...
public class HighScoreTest {
    ...
    public void testGettersSetters() {
        ...
        assertEquals("Zwrocony nick musi byc adekwatny do nazwy podczas inicjalizacji", "Gracz123", wynik.getNick());
        ...
        assertEquals("Gettery powinny poprawnie odzwierciedlac swieza uaktualniona wartosc z uzyciem setterow", 1250,
                wynik.getPunkty());
